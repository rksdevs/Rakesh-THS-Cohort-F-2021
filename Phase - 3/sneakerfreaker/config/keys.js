...
if (process.env.NODE_ENV === "PROD") {
  ...
  keys.emailPass = procecss.env.EMAIL_PASSWORD_PROD;
  ...
  keys.fronstEndBaseUrl = process.env.FRONTEND_BASE_URL_PROD;
  ...
  keys.rzpKeyId = process.env.RZP__KEY_ID_PROD;
  ...
  keys.fronstEndBaseUrl = process.env.FRONTEND_BASE_URL_DEV;
